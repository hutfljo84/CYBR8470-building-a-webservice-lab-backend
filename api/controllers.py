...
def xss_example(request):
    ...
    """
    return render_to_response("dumb-test-app/index.html", {}, RequestContext(request))
...
class Register(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        educationlevel = request.POST.get(
            "educationlevel"
        ...
        return Response(
            {"status": "success", "userid": newuser.id, "profile": newprofile.id}
        )
...
class Events(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            e
            return Response(
                {"success": False, "error": e}, status=status.HTTP_400_BAD_REQUEST
            )
